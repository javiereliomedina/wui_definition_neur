...
![](figures/counties_map.png)
![WUI percentage by county](figures/counties_wui_perc.png)


Area of wild vegetation by county (@tbl-summary-table-areas): Number vegetation cells (centroid is inside the polygon), sum then and calculate the area based on the raster resolution.
...
We analyse all wildfires that have affected buildings from 2016 to 2022 (i.e., 330). The data have been obtained from XX (Norway) and XXX (Sweden).
